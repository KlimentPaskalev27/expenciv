...
const DeleteExpensePage = ({ route }) => {
  ...
  const handleDeleteExpense = async (index) => {
    try {
      ...
      console.log("thisMonthsDataWithRemovedItem is " + thisMonthsDataWithRemovedItem)
      ...
      // update local variable for the current month's expenses
      //setExpensesData(updatedExpenses.filter(expense => expense.month == selectedMonth));
